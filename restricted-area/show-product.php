...
<section id="containerColumn" class="container-fluid">
    ...
    <div class="column-1">
        <h3 class="restricted-title-section">Registrar produtos</h3>
        <form id="form" class="form" method="post" action="crud-product.php" enctype="multipart/form-data">
            ...
            <input autofocus type="text" id="nameInput" class="rt-text-input select-disable" name="productName" maxlength="40" placeholder="Nome do produto">
            <p class="error-text">Informe o nome do produto.</p>
            ...
            <p class="error-text">Informe a descrição do produto.</p>
            ...
            <p class="error-text">Envie uma imagem do produto.</p>
    ...
    <div class="column-2 container">
        <h3 class="restricted-title-section">Produtos registrados</h3>
        <div class="img-col">
            <?php foreach ($stmt as $row) { ?>
                <div class="restricted-img-container">
                    ...
                    <div class="btn-container">
                        <a type="button" class="btn btn-delete" data-bs-toggle="modal" data-bs-target="#deleteProductModal" data-bs-id="<?php echo $row[0] ?>">Excluir</a>
                        ...
                        <a type="button" class="btn btn-edit" data-bs-toggle="modal" data-bs-target="#editProductModal" data-bs-id="<?php echo $row[0] ?>" data-bs-name="<?php echo $row[2] ?>" data-bs-desc="<?php echo $row[1] ?>">Editar</a>
                        <div id="editProductModal" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form id="formModal" method="post" action="crud-product.php" enctype="multipart/form-data">
